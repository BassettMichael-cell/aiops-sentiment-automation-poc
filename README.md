...
![CI Pipeline](https://github.com/BassettMichael-cell/aiops-sentiment-automation-poc/actions/workflows/train-model.yml/badge.svg)

### 🎮 Live Interactive Demo
Try the model right now!  
[![Live Demo](https://img.shields.io/badge/Live%20Demo-Click%20Here-brightgreen?style=for-the-badge&logo=streamlit)]([https://aiops-sentiment-demo.onrender.com](https://aiops-sentiment-demo.onrender.com))
